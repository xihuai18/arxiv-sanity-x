...
This directory contains operational and developer-facing documentation for arxiv-sanity-X.
...
- Defaults Reference: [DEFAULTS.md](DEFAULTS.md)
- Open Source: [OPEN_SOURCE.md](OPEN_SOURCE.md)
